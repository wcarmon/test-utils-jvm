...
val mvnArtifactId = "test-utils-jvm" // see settings.gradle.kts
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = mvnArtifactId
                description = "Utilities for using JUnit"
                url = "https://github.com/wcarmon/test-utils-jvm"

                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/test-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/test-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/test-utils-jvm.git"
                    url = "https://github.com/wcarmon/test-utils-jvm/tree/main"
                }
            }
        }
    }
